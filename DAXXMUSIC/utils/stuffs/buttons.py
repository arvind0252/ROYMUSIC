...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("𝐂𝐇𝐀𝐓𝐆𝐓𝐏", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("𝐆𝐑𝐎𝐔𝐏𝐒", callback_data="mplus HELP_Group"),InlineKeyboardButton("𝐒𝐓𝐈𝐂𝐊𝐄𝐑𝐒", callback_data="mplus HELP_Sticker")],
